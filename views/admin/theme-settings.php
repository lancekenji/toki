	...
	<div class="col-12">
		<div class="card">
			<div class="container-fluid">
				<div class="card-body">
					<form class="admin-settings-page forms" id="forms">
						<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide website logo") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide how it works section") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide featured restaurant section") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide browse by cuisine section") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide subscription section") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide connect with us section") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide language bar") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							...
							echo CHtml::textArea('theme_custom_footer', getOptionA('theme_custom_footer'), array(
								'class' => "form-control big-text-area"
							))
							?>
						</div>
						...
						<div class="row mb-3">
							...
							echo CHtml::dropDownList(
								...
								getOptionA('featured_merchant_sort'),
								array(
									'' => t("Select options"),
									1 => t("Random"),
									2 => t("Sort by name"),
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled search by address") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled search by restaurant name") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled search by street name") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled search by cuisine") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled search by food name") ?></label>
							<?php
						...
						<div class="row mb-3">
							...
							echo CHtml::dropDownList(
								'theme_top_menu[]',
								(array)FunctionsV3::getTopMenuActivated(),
								$menus,
								array(
									'class' => "chosen w-100",
									"multiple" => "multiple"
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide Menu section") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Hide Others section") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Enabled mobile app section") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Do not collapse all filters") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Enabled Maps") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Do not collapse menu") ?>?</label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled opening hours tab") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled reviews tab") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled table booking tab") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled map tab") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled photos tab") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled information tab") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Disabled promo tab") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Enabled Cookie law") ?></label>
							<?php
						...
						<div class="row mb-3">
							<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Enabled") ?></label>
							<?php
							echo CHtml::checkBox(
								'age_restriction',
								getOptionA('age_restriction') == 1 ? true : false,
								array(
									'value' => 1
								)
							)
						...
						<div class="row mb-3">
							...
							echo CHtml::textArea(
								...
								getOptionA('age_restriction_content'),
								array(
									'class' => "form-control"
								)
							);
						...
						<div class="row mb-3">
							...
							echo CHtml::textField(
								...
								getOptionA('age_restriction_exit_link'),
								array(
									'class' => "form-control"
								)
							);
						...
						<div style="display:none;">
							...
							<div class="row mb-3">
								<label class="form-label" style="width:180px;padding-right:20px;"><?php echo t("Enabled Time Picker UI") ?></label>
								<?php
